    ...
    <article className='weather'>
      ...
      <section className='weather__body'>
        <header className='weather__img-container'>
          <img className='weather__img' src={`https://openweathermap.org/img/wn/${weather?.weather[0].icon}@2x.png`}></img>
        </header>
      ...
      <button className='weather__btn' onClick={handleChangeTemp}> Change to {isCelsius ? 'Fahrenheit' : 'Celsius'}</button>
    </article>
  )
}
